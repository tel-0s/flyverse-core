...
7. **`FLYVERSE_CACHE` becomes the cache root for every dataset including MaleCNS** (B2) -- record this as a decision
...
## 12. Follow-up resolutions (Astra, after merge at 4db2e8c)

This appendix records implementation follow-ups; the independent review above is unchanged. B1-B4 and nits
1/3/9/12-15 were resolved by Fable in 34c2eb0. In particular, the original decision 11.7 above was superseded:
...
| 4 | FAFB entryNerve is restricted to sensory/sensory_ascending/sensory_descending rows. This clears 3,250 non-sensory annotations; exitNerve remains motor/endocrine-only. |
