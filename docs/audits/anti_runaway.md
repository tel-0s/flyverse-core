...
backend, NVIDIA B200, shared override cache (sum|W| 121,460,584), run dir `/mnt/beegfs/neurome/runs/r4-retire-4620b3`,
...
`/mnt/beegfs/neurome/runs/r4-rescore-680005`, `config.receptor` = sign / abs / flag `default` / 48,295 entries):
