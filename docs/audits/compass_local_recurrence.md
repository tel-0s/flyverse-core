...
**The failure line: `10 job(s), 0 failed  (4.3 min)  run dir <cluster-fs>/neurome/runs/cx7-201788`, `client exit 0`**;
...
validation:
  ...
  - "scheduler receipt 10 job(s), 0 failed ({'completed': 10}), <cluster-node> / B200 / GPU ids 0-1; client '10 job(s), 0 failed (4.3 min) run dir <cluster-fs>/neurome/runs/cx7-201788'; 40/40 json+txt+npz; 40/40 consoles 'device cuda'; analysis problems 0"
