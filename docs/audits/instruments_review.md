...
**Scope.** This review covers `a41d0f2..6d1c501` (plus section 5 at `a20d0ed`) and its 468 / 469-passing suite
numbers. It does NOT cover `flyverse/compass.py`, `flyverse/navigation.py`, `FlyBrain.interoception()` or the four
navigation instruments now on main at `3ee368a` (503 passing); those are reviewed in
