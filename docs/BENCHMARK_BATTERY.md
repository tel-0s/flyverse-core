...
| 2b | looming escape, long mode | slow expansion -> GF-independent, wing raise, directed | untested | `start_loom` takes a speed; readouts exist for TTMn, wing power / steering MNs and DNp11-class DNs. Score: wing-MN activity precedes TTMn at low l/v, GF silent. |
| 3 | landing response | gentle expansion -> leg extension, no takeoff | untested | leg-MN readouts exist (`leg_L/R`); needs a slow, small-final-size loom and a landing criterion (leg MN rise without GF / wing power). |
