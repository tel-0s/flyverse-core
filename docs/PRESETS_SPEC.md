...
| `glno_sign` | relabel | GLNO sign 0 (three EM classifiers agree only that GLNO is inhibitory and disagree on the transmitter, `glno_relabel.md` 1.2) | glutamate, the call two of the three make; safe on the suite, fixes nothing alone (5B) | built and run: round 2 / 5B relabel, round 7 component; **admissible** as part of the three-instrument list (section 7) |
